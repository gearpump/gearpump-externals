...
import org.apache.gearpump.streaming.kafka.lib.source.consumer.{KafkaConsumer, KafkaMessage}
...
import org.apache.gearpump.streaming.kafka.lib.util.KafkaClient
import org.apache.gearpump.streaming.kafka.util.{KafkaConfig, MockUtil}
